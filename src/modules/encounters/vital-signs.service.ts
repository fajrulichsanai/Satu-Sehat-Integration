...
const VITAL_SIGN_DEFS: VitalSignDef[] = [
  { field: 'sistolic', loincCode: '8480-6', name: 'Tekanan Darah Sistolik', unit: 'mmHg', normalMin: 90, normalMax: 120 },
  { field: 'diastolic', loincCode: '8462-4', name: 'Tekanan Darah Diastolik', unit: 'mmHg', normalMin: 60, normalMax: 80 },
  { field: 'heartRate', loincCode: '8867-4', name: 'Denyut Jantung', unit: '/menit', normalMin: 60, normalMax: 100 },
  { field: 'respiratoryRate', loincCode: '9279-1', name: 'Frekuensi Napas', unit: '/menit', normalMin: 12, normalMax: 20 },
  { field: 'temperature', loincCode: '8310-5', name: 'Suhu Tubuh', unit: '°C', normalMin: 36.1, normalMax: 37.2 },
  { field: 'weight', loincCode: '29463-7', name: 'Berat Badan', unit: 'kg', normalMin: 0.5, normalMax: 500 },
  { field: 'height', loincCode: '8302-2', name: 'Tinggi Badan', unit: 'cm', normalMin: 30, normalMax: 250 },
  { field: 'spo2', loincCode: '59408-5', name: 'SpO2', unit: '%', normalMin: 95, normalMax: 100 },
];
...
export class VitalSignsService {
  ...
  async upsert(encounterId: number, clinicId: number, dto: UpsertVitalSignsDto, userId: number) {
    await this.verifyEncounter(encounterId, clinicId);
    ...
    for (const def of VITAL_SIGN_DEFS) {
      const value = dto[def.field] as number | undefined;
      ...
      await this.vitalSignRepository.delete({ encounterId, loincCode: def.loincCode });
